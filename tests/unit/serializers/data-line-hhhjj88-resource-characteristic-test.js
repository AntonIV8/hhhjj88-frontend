...
moduleForModel('data-line-hhhjj88-resource-characteristic', 'Unit | Serializer | data-line-hhhjj88-resource-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-hhhjj88-resource-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

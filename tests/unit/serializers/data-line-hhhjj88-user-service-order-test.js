...
moduleForModel('data-line-hhhjj88-user-service-order', 'Unit | Serializer | data-line-hhhjj88-user-service-order', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-hhhjj88-user-service-order',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

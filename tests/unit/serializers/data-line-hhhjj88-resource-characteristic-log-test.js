...
moduleForModel('data-line-hhhjj88-resource-characteristic-log', 'Unit | Serializer | data-line-hhhjj88-resource-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-hhhjj88-resource-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

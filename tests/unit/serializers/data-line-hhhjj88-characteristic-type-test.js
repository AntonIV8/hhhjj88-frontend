...
moduleForModel('data-line-hhhjj88-characteristic-type', 'Unit | Serializer | data-line-hhhjj88-characteristic-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-hhhjj88-characteristic-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

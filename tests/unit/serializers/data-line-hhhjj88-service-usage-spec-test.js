...
moduleForModel('data-line-hhhjj88-service-usage-spec', 'Unit | Serializer | data-line-hhhjj88-service-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-hhhjj88-service-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

...
export let ValidationRules = {
  description: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.description.__caption__',
    validators: [
      validator('ds-error'),
    ],
  },
  dt_completed: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.dt_completed.__caption__',
    validators: [
      validator('ds-error'),
      validator('date'),
    ],
  ...
  dt_created: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.dt_created.__caption__',
    validators: [
      validator('ds-error'),
      validator('date'),
  ...
  dt_modified: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.dt_modified.__caption__',
    validators: [
      validator('ds-error'),
      validator('date'),
      validator('presence', true),
  ...
  dt_started: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.dt_started.__caption__',
    validators: [
      validator('ds-error'),
      validator('date'),
    ],
  ...
  external_id: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.external_id.__caption__',
    validators: [
      validator('ds-error'),
    ],
  },
  price: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.price.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  contragent_id: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.contragent_id.__caption__',
    validators: [
      validator('ds-error'),
    ],
  },
  customer_id: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.customer_id.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  state: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.state.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  modifier_id: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.modifier_id.__caption__',
    validators: [
      validator('ds-error'),
    ],
  },
  creator_id: {
    descriptionKey: 'models.data-line-hhhjj88-service-order.validations.creator_id.__caption__',
    validators: [
      validator('ds-error'),
    ],
  },
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('service_orderE', 'data-line-hhhjj88-service-order', {
  ...
  modelClass.defineProjection('service_orderL', 'data-line-hhhjj88-service-order', {
    description: attr('Description', { index: 0 }),
    dt_completed: attr('Dt_completed', { index: 1 }),
    dt_created: attr('Dt_created', { index: 2 }),
    dt_modified: attr('Dt_modified', { index: 3 }),

...
export let ValidationRules = {
  a_create: {
    descriptionKey: 'models.data-line-hhhjj88-customer-acl.validations.a_create.__caption__',
    validators: [
      validator('ds-error'),
  ...
  a_read: {
    descriptionKey: 'models.data-line-hhhjj88-customer-acl.validations.a_read.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  a_update: {
    descriptionKey: 'models.data-line-hhhjj88-customer-acl.validations.a_update.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  a_delete: {
    descriptionKey: 'models.data-line-hhhjj88-customer-acl.validations.a_delete.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  customer_id: {
    descriptionKey: 'models.data-line-hhhjj88-customer-acl.validations.customer_id.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  group_id: {
    descriptionKey: 'models.data-line-hhhjj88-customer-acl.validations.group_id.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('customer_aclE', 'data-line-hhhjj88-customer-acl', {
  ...
  modelClass.defineProjection('customer_aclL', 'data-line-hhhjj88-customer-acl', {
    a_create: attr('A_create', { index: 0 }),
    a_read: attr('A_read', { index: 1 }),
    a_update: attr('A_update', { index: 2 }),
    a_delete: attr('A_delete', { index: 3 }),

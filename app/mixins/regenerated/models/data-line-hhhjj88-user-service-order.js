...
export let ValidationRules = {
  action: {
    descriptionKey: 'models.data-line-hhhjj88-user-service-order.validations.action.__caption__',
    validators: [
      validator('ds-error'),
  ...
  dt_action: {
    descriptionKey: 'models.data-line-hhhjj88-user-service-order.validations.dt_action.__caption__',
    validators: [
      validator('ds-error'),
      validator('date'),
      validator('presence', true),
  ...
  service_order_id: {
    descriptionKey: 'models.data-line-hhhjj88-user-service-order.validations.service_order_id.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
  ...
  user_id: {
    descriptionKey: 'models.data-line-hhhjj88-user-service-order.validations.user_id.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('user_service_orderE', 'data-line-hhhjj88-user-service-order', {
  ...
  modelClass.defineProjection('user_service_orderL', 'data-line-hhhjj88-user-service-order', {
    action: attr('Action', { index: 0 }),
    dt_action: attr('Dt_action', { index: 1 }),
